                            ...
                            <div class="container-fluid">
                              <nav class="navbar navbar-expand-md">
                                ...
                                <div class="collapse navbar-collapse mt-2 mt-md-0" id="navbarNav0">
                                  <p class="m-auto">
                                    <a class="btn btn-outline-primary m-1" href="<?php echo e(route('user.create')); ?>">Tambah</a>
                            ...
                            <table id="dt4" class="table table-sm">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="text-center"><?php echo e($v->telpon); ?></td>
                                  <td class="text-center"><?php echo e($v->email); ?></td>
                                  <td class="text-right">
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="<?php echo e(route('user.edit',$v->id)); ?>">Edit</a>
                                        <form id="delete-form-<?php echo e($v->id); ?>"
                                            method="post"
                                            action="<?php echo e(route('user.destroy', $v->id)); ?>"
                                            style="display: none;">
