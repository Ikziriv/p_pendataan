                            ...
                            <div class="container-fluid">
                              <nav class="navbar navbar-expand-md">
                                ...
                                <div class="collapse navbar-collapse mt-2 mt-md-0" id="navbarNav0">
                                  <p class="m-auto">
                                    <a class="btn btn-outline-primary m-1" href="<?php echo e(route('kk.create')); ?>">Tambah</a>
                            ...
                            <table id="dt4" class="table table-sm">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col" class="text-center">NIK KK</th>
                                  <th scope="col" class="text-right">Action</th>
                                </tr>
                              </thead>
                              <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $kks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                  <th scope="row"><?php echo e($key+1); ?></th>
                                  <?php $warga = \App\Warga::where('id', $v->warga_id)->first(); ?>
                                  <td class="text-center"><?php echo e($warga->nik_warga); ?></td>
                                  <td class="text-center"><?php echo e($warga->name); ?></td>
                                  <td class="text-center"><?php echo e($v->nomor_keluarga); ?></td>
                                  <td class="text-right">
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="<?php echo e(route('kk.edit',$v->id)); ?>">Edit</a>
                                        <form id="delete-form-<?php echo e($v->id); ?>"
                                            method="post"
                                            action="<?php echo e(route('kk.destroy', $v->id)); ?>"
                                            style="display: none;">
