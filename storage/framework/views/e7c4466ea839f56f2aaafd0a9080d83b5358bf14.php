                                ...
                                <form method="POST" action="<?php echo e(route('kk.store')); ?>"><?php echo csrf_field(); ?>
                                  <div class="fdb-box fdb-touch">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col mt-4">
                                        <input type="text" class="form-control <?php echo e($errors->has('nomor_keluarga') ? ' is-invalid' : ''); ?>" name="nomor_keluarga" placeholder="Nomer KK (Kartu Keluarga)">
                                    ...
                                    <div class="row mt-4">
                                      <div class="col">
                                        <textarea class="form-control <?php echo e($errors->has('alamat') ? ' is-invalid' : ''); ?>" cols="3" name="alamat" placeholder="Keterangan"></textarea>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col mt-4">
                                        <input type="text" class="form-control <?php echo e($errors->has('kodepos') ? ' is-invalid' : ''); ?>" name="kodepos" placeholder="Kode POS">
