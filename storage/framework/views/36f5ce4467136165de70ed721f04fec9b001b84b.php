                            ...
                            <div class="container-fluid">
                              <nav class="navbar navbar-expand-md">
                                ...
                                <div class="collapse navbar-collapse mt-2 mt-md-0" id="navbarNav0">
                                  <p class="m-auto">
                                    <a class="btn btn-outline-primary m-1" href="<?php echo e(route('mutasi.create')); ?>">Tambah</a>
                        ...
                        <div class="row text-left">
                          <div class="col-12 col-sm-12 col-md-12 col-lg-12 m-sm-auto mr-md-auto ml-md-0">
                            <table id="dt4" class="table table-sm">
                              ...
                              <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $mutasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                  <th scope="row"><?php echo e($key+1); ?></th>
                                  <td class="text-center"><?php echo e($v->nik_mutasi); ?></td>
                                  ...
                                  <td class="text-right">
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="<?php echo e(route('mutasi.edit',$v->id)); ?>">Edit</a>
                                        <form id="delete-form-<?php echo e($v->id); ?>"
                                            method="post"
                                            action="<?php echo e(route('mutasi.destroy', $v->id)); ?>"
                                            style="display: none;">
