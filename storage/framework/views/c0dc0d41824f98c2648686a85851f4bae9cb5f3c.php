                              ...
                              <div class="col-12 col-md-12 col-lg-12 text-center">
                                <form method="POST" action="<?php echo e(route('galeri.store')); ?>" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                                  <div class="fdb-box fdb-touch">
                                    ...
                                    <div class="row">
                                      <div class="col mt-4">
                                        <input type="text" class="form-control <?php echo e($errors->has('caption') ? ' is-invalid' : ''); ?>" name="caption" placeholder="Caption">
                                      ...
                                      <div class="col mt-4">
                                        <input type="text" class="form-control <?php echo e($errors->has('tautan') ? ' is-invalid' : ''); ?>" name="tautan" placeholder="Tautan">
