          ...
          <div class="container">
            <nav class="navbar navbar-expand-md">
              ...
              <div class="collapse navbar-collapse" id="navbarNav1">
                ...
                @guest
                    {{-- <a class="btn btn-sm btn-outline-primary ml-md-3" href="{{ route('login') }}">
                    {{ __('Login') }}</a>
                    @if (Route::has('register'))
                        <a class="btn btn-sm btn-outline-primary ml-md-3" href="{{ route('register') }}">
                        {{ __('Register') }}</a>
                    @endif --}}
                @else
                    <li class="nav-item dropdown">
                        ...
                        <a class="btn btn-sm btn-outline-primary ml-md-3" href="{{ route('logout') }}"
