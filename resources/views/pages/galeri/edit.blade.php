                              ...
                              <div class="col-12 col-md-12 col-lg-12 text-center">
                                <form method="POST" action="{{ route('galeri.store') }}" enctype="multipart/form-data">@csrf
                                  <div class="fdb-box fdb-touch">
                                    ...
                                    <div class="row">
                                      <div class="col mt-4">
                                        <img src="{{asset($galeri->path.$galeri->filename)}}" height="200px" />
                                    ...
                                    <div class="row">
                                      <div class="col mt-4">
                                        <input type="text" class="form-control {{ $errors->has('caption') ? ' is-invalid' : '' }}" name="caption" value="{{$galeri->caption}}" placeholder="Caption">
                                      ...
                                      <div class="col mt-4">
                                        <input type="text" class="form-control {{ $errors->has('tautan') ? ' is-invalid' : '' }}" name="tautan" value="{{$galeri->tautan}}" placeholder="Tautan">
